...
grade=100
#########################################################################
printf "testing pc_test_01... "
$script_dir/producer_consumer/test_01.sh >/dev/null 2>&1
if [ $? -eq 0 ]
then
  echo "ok"
else
...
#########################################################################
printf "testing pc_test_04... "
$script_dir/producer_consumer/test_04.sh >/dev/null 2>&1
if [ $? -eq 0 ]
then
  echo "ok"
else
